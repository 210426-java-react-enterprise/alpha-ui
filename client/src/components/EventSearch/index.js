    ...
    <>
      ...
      {event.isShown && (
        <Row>
          <Col>
            <Row>
              <Col className="d-flex justify-content-center align-items-center bg-dark p-2 ml-3 mr-3 mt-2 border border-dark">
                    ...
                    <tr id={"event-" + i} key={i}>
                      ...
                      <td>
                        <a target="_blank" href={row.event_url}>
                          ...
                          <td><Button disabled={false} id={"btn-" + i} onClick={saveEventOnClick}>Save</Button></td>
                    </tr>
                  );
                })}
              </tbody>
